...
augroup AuHiColorTxt
 ...
 au WinLeave hicolors.txt	sil! unmap <cr>|sil! unmap <LeftMouse>|sil! unmap <RightMouse>|sil! unmap <LeftDrag>|sil! unmap <2-LeftMouse>
...
"   call Decho("exe sil! help hl-".color)
   let v:errmsg=""
   exe "sil! help hl-".color
   let errmsg= v:errmsg
   nno <silent> <buffer> <2-leftmouse>  :set lz<bar>he hicolors<bar>set nolz<cr>
"   call Decho("v:errmsg<".v:errmsg.">")
   if errmsg != "" && errmsg !~ '^E490:' && errmsg !~ '^E31'
    he group-name
	nnoremap <silent> <buffer> <2-leftmouse>  :set lz<bar>he hicolors<bar>set nolz<cr>
