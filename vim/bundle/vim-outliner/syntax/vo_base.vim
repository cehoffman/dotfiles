...
hi def link OL1 Statement 
hi def link OL2 Identifier
hi def link OL3 Constant
hi def link OL4 PreProc   
hi def link OL5 Statement 
hi def link OL6 Identifier
hi def link OL7 Constant
hi def link OL8 PreProc   
hi def link OL9 Statement

"colors for tags
" hi def link outlTags Tag
hi def link outlTags Todo
...
"color for pre-formatted text
hi def link PT1 Special
hi def link PT2 Special
hi def link PT3 Special
hi def link PT4 Special
hi def link PT5 Special
hi def link PT6 Special
hi def link PT7 Special
hi def link PT8 Special
hi def link PT9 Special

"color for tables 
hi def link TA1 Type
hi def link TA2 Type
hi def link TA3 Type
hi def link TA4 Type
hi def link TA5 Type
hi def link TA6 Type
hi def link TA7 Type
hi def link TA8 Type
hi def link TA9 Type

"color for user text (wrapping)
hi def link UT1 Debug
hi def link UT2 Debug
hi def link UT3 Debug
hi def link UT4 Debug
hi def link UT5 Debug
hi def link UT6 Debug
hi def link UT7 Debug
hi def link UT8 Debug
hi def link UT9 Debug

"color for user text (non-wrapping)
hi def link UB1 Underlined
hi def link UB2 Underlined
hi def link UB3 Underlined
hi def link UB4 Underlined
hi def link UB5 Underlined
hi def link UB6 Underlined
hi def link UB7 Underlined
hi def link UB8 Underlined
hi def link UB9 Underlined

"colors for folded sections
hi def link Folded Special
hi def link FoldColumn Type
