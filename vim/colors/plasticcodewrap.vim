...
hi LineNr                       cterm=NONE           ctermfg=238  ctermbg=NONE gui=NONE                  guifg=#82878b guibg=NONE
hi Question                     cterm=bold           ctermfg=39   ctermbg=NONE gui=bold                  guifg=#00ff00 guibg=NONE
...
hi VertSplit                    cterm=NONE           ctermfg=236  ctermbg=236  gui=NONE                  guifg=#303030 guibg=#303030
hi Title                        cterm=bold           ctermfg=251  ctermbg=NONE gui=bold                  guifg=#f8f8f8 guibg=NONE
hi Visual                       cterm=NONE           ctermfg=NONE ctermbg=17   gui=NONE                  guifg=NONE    guibg=#00005f
...
hi DiffText                     cterm=bold           ctermfg=251  ctermbg=232  gui=bold                  guifg=NONE    guibg=#660000
...
hi Conceal                      cterm=NONE           ctermfg=172  ctermbg=NONE gui=NONE                  guifg=#c98600 guibg=#0b161d
hi CSVColumnEven                cterm=none           ctermfg=251  ctermbg=NONE gui=none                  guifg=#c6c6c6 guibg=#0b161d
hi CSVColumnHeaderEven          cterm=underline,bold ctermfg=172  ctermbg=NONE gui=underline,bold        guifg=#c98600 guibg=#0b161d
hi CSVColumnOdd                 cterm=none           ctermfg=251  ctermbg=NONE gui=none                  guifg=#c6c6c6 guibg=#0b161d
hi CSVColumnHeaderOdd           cterm=underline,bold ctermfg=172  ctermbg=NONE gui=underline,bold        guifg=#c98600 guibg=#0b161d
hi CSVHiColumn                  cterm=none           ctermfg=184  ctermbg=NONE gui=none                  guifg=#ffd700 guibg=#0b161d
hi CSVHiColumnHeader            cterm=underline,bold ctermfg=172  ctermbg=NONE gui=underline,bold        guifg=#c98600 guibg=#0b161d
...
hi Pmenu                        cterm=NONE           ctermfg=236  ctermbg=230  gui=NONE                  guifg=#00c2ff guibg=#0b161d
hi PmenuSel                     cterm=bold           ctermfg=251  ctermbg=66   gui=bold                  guifg=#00c2ff guibg=#2b5670
...
hi TabLine                      cterm=underline      ctermfg=251  ctermbg=NONE gui=underline             guifg=NONE    guibg=#a9a9a9
hi TabLineSel                   cterm=bold,underline ctermfg=226  ctermbg=NONE gui=bold,underline        guifg=NONE    guibg=NONE
hi TabLineFill                  cterm=underline      ctermfg=251  ctermbg=NONE gui=underline             guifg=NONE    guibg=NONE
hi SignColumn                   cterm=NONE           ctermfg=238  ctermbg=NONE gui=NONE                  guifg=#82878b guibg=NONE
hi ColorColumn                  cterm=NONE           ctermfg=NONE ctermbg=232  gui=NONE                  guifg=NONE    guibg=#0f0f0f
hi CursorColumn                 cterm=NONE           ctermfg=251  ctermbg=234  gui=NONE                  guifg=NONE    guibg=#081015
...
hi MatchParen                   cterm=bold           ctermfg=7    ctermbg=NONE gui=bold                  guifg=#e0e0e0 guibg=NONE
hi Comment                      cterm=NONE           ctermfg=32   ctermbg=NONE gui=italic                guifg=#0e8ad0 guibg=NONE
...
hi Statement                    cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi PreProc                      cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi Type                         cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
...
hi Function                     cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
hi Conditional                  cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi Label                        cterm=NONE           ctermfg=77   ctermbg=NONE gui=NONE                  guifg=#55e439 guibg=NONE
hi Operator                     cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi Keyword                      cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi Define                       cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi StorageClass                 cterm=NONE           ctermfg=228  ctermbg=NONE gui=NONE                  guifg=#f6f080 guibg=NONE
hi Tag                          cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
...
hi rubyControl                  cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
...
hi rubyException                cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi rubyClass                    cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
hi rubyPseudoVariable           cterm=NONE           ctermfg=209  ctermbg=NONE gui=NONE                  guifg=#fb9a4b guibg=NONE
" hi rubyOperator                 cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
...
hi rubyFunction                 cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
...
hi rubyInclude                  cterm=bold           ctermfg=172  ctermbg=NONE gui=bold                  guifg=#c98600 guibg=NONE
...
" hi yamlKey                      cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
...
" hi cssClassName                 cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
...
" hi cssPseudoClassId             cterm=bold           ctermfg=184  ctermbg=NONE gui=bold                  guifg=#00c2ff guibg=NONE
